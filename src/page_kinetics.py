"""!@page page_kinetics Kinematic Derivations
    @section sec1 Home Position
    ...
    We also know that the encoder pulses (ticks) per revolution is:
        ...
        x 4 [pulses per count for quadrature encoders]
        x 16 [16:1 gear ratio]
    
    Therefore we have the ticks per mm ratio as:
        - ppr / r = 512 [ticks/mm]

    So we have the final output (theta_1, theta_2) in ticks:
        - th1 = TICKS_PER_MM * r_1
        - th2 = TICKS_PER_MM * r_2
