...
class Servo:
    ...
    def __init__ (self, pin1 = pyb.Pin.board.PA6, timer = pyb.Timer(3, freq=50), timerChannel = 1 ):
        """!
        ...
        self._channel = self._timer.channel(timerChannel, pyb.Timer.PWM, pin=pin1)
